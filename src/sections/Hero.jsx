...
const Hero = () => {
    return (
        <section id="home" className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 border-2 border-red-500">
            <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
                ...
                <div className="flex justify-starts items-start flex-wrap w-full mt-20 gap-6">
                    {statistics.map((stat) => (
                        <div key={stat.label}>
